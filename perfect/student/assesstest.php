...
<head>
	...
	<body class="page-header-fixed page-horizontal-bar"  onblur="myFunction1()">
        ...
        <main class="page-content content-wrap container">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                        <a class="logo-text" style="color:black"><span style="color:black"><div id="quiz-time-left" style="color:black"></div></span></a>
                    </div>
...
//   alert("Window Violation Recorded");
