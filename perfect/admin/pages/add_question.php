...
$sql = "INSERT INTO tbl_questions (question_id, exam_id, type, question, tag, option1, option2, option3, option4, answer)
VALUES ('$question_id', '$examid', 'MC', '$question', '$tag' , '$opt1', '$opt2', '$opt3', '$opt4', '$answer')";
