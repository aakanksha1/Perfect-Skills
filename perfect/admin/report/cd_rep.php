...
$sql1 = "SELECT * FROM `tbl_assessment_records` WHERE `student_id` = '$student_id'";
...
<div class="col-md-4" style="padding-top: 3px;padding-bottom: 5px;">
...
<div class="col-md-12 text-left" style="padding-top: 10px;border-style: solid;border-color: whitesmoke;">
     ...
     <div class="table-responsive">
									...
									print '
                                     ...
                                     print '
                                            ...
                                            <tr>
                                                ...
                                                <td>'.$row['score'].'%</td>
                                                <td>'.($row['status'] = "Intermediate" ? "<center><p style='background-color:#F0AD4E;color:white;text-center'>Intermediate</p></center>"  : "<p style='background-color:green'>NA</p>") .'</td>
                                    ...
                                    if(val1>=0 && val1<=24)
                    {
                        ...
                        document.getElementById("graphic").innerHTML = "1g";
                    }
                    else if(val1>=25 && val1<=49)
                    {
                        ...
                        document.getElementById("graphic").innerHTML = "2g";
                    }
                    else if(val1>=50 && val1<=74)
                    {
                        ...
                        document.getElementById("graphic").innerHTML = "3g";
                    }
                    else if(val1>=75 && val1<=100)
                    {
                        ...
                        document.getElementById("graphic").innerHTML = "4g";
                    }
                    }
