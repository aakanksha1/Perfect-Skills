...
<!-- main-content -->
<div class="container-full" style="border-style: solid;border-color: #1F253D;">
    <div class="container-full"  >
        <div class="col-md-12" >
<div class="col-md-4" style="padding-top: 10px;padding-bottom: 5px;">
    <div class="col-md-12">
        <div class="col-md-5">
            <span style="color: #1F253D;font-size:16px"> Name:</span><br>
        </div>
        
        <div class="col-md-7">
            <span style="color: #1F253D;font-size:16px"> <?php echo "$sdfname"."&nbsp;".$sdlname ?></span>
        </div>
    </div>
    
    <div class="col-md-12">
        <div class="col-md-5">
            <span style="color: #1F253D;font-size:16px"> User-Id:</span>
        </div>
        
        <div class="col-md-7">
            <span style="color: #1F253D;font-size:16px"> <?php echo "$student_id" ?></span>
        </div>
    </div>
    
    <div class="col-md-12">
        <div class="col-md-2">
            <span style="color: #1F253D;font-size:16px"> Email:</span>
        </div>
        
        <div class="col-md-10">
            <span style="color: #1F253D;font-size:16px"> <?php echo "$sdemail" ?></span>
        </div>
    </div>
    
    
</div>
<div class="col-md-3" style="padding-top: 3px;padding-bottom: 5px;">
    
                <span style="color: #1F253D;font-size:16px">Overall Score : <span style="color: #1F253D;font-size:16px;" id="scorehere">00</span><span style="color: #1F253D;font-size:22px;">%</span></span><br>
                
                <span style="color: #1F253D;font-size:16px">Appeared on : <span style="color: #1F253D;font-size:16px;"><?php echo "$exam_date1" ?></span></span><br>
                
                <span style="color: #1F253D;font-size:16px">Proficiency Level : <span style="color: #5CB85C;font-size:18px;font-weight:800" id="cdlevel"> Status</span></span>
                
                
            </div>
<div class="col-md-1 text-center" style="padding-top: 5px;padding-bottom: 5px;">
    <?php 
    $idval = $_GET['sid'];
    echo " <img class='img-circle avatar' src='../../student/pages/upload/$idval.png' width='100px' height='100px' alt='No Image Found'>"; 
    ?>
    
</div>
<div class="col-md-4 text-right" style="padding-top: 10px;padding-bottom: 5px;">
   
    <!--<img src="apt.jpeg" style="width: 60%">-->
...
<div class="col-md-12 text-left" style="padding-top: 10px;border-style: solid;border-color: whitesmoke;">
    <!--<td><h2 style="color: #1F253D"><a href="../allques_report.php?eid='.$recid.'"><button class="btn btn-success">Detailed Report</button></a></h2></td>-->
                     ...
                     <table id="resultexample" class="display table" style="width: 100%; cellspacing: 0;">
                                     ...
                                     print '
                                            ...
                                            <tr>
                                                ...
                                                <td><h2 style="color: #1F253D"><a href="../allques_report.php?eid='.$nname.'" target="_blank"><button class="btn btn-success">Detailed Report</button></a></h2></td>
...
<span style="color: #1F253D;font-size:16px"> Proficiency Level of <?php echo "$sdfname"."&nbsp;".$sdlname ?>:</span>
<span style="color: #5CB85C;font-size:16px;" id="aggstatus"> Status</span>
 <br><br>
 <div class="col-md-4"></div>
 <div class="col-md-4">
<div class="progress text-center" style="height:40px;border:0px solid red;background-color:white;">
    <div class="progress-bar progress-bar-danger" role="progressbar" style="width:100%;border:1px solid white;border-radius:50px" id="level1">
      
        <p class="level1" style="font-size:12px;color:white;font-weight:700;margin-top:6px">Beginner (0-24%)</p>
    </div>
    <div class="progress-bar progress-bar-warning" role="progressbar" style="width:100%;border:1px solid white;border-radius:50px" id="level2">
      
        <p class="level2" style="font-size:12px;color:white;font-weight:700;margin-top:6px">Intermediate (25-49%)</p>
    </div>
    <div class="progress-bar" role="progressbar" style="width:100%;border:1px solid white;border-radius:50px" id="level3">
      
        <p class="level3" style="font-size:12px;color:white;font-weight:700;margin-top:6px">Advanced (50-74%)</p>
    </div>
    <div class="progress-bar progress-bar-success" role="progressbar" style="width:100%;border:1px solid white;border-radius:50px" id="level4">
      
        <p class="level4" style="font-size:12px;color:white;font-weight:700;margin-top:6px">Profecient (75-100%)</p>
    </div>
</div>
</div>
<div class="col-md-4"></div>
