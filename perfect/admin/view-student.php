...
function myFunction() {
  alert("I am an alert box!");
    ...
    <body <?php if ($ms == "1") { print 'onload="myFunction()"'; } ?>  class="page-header-fixed" onload="myFunction()">
                    ...
                    <div class="row">
						...
						<div class="row">
                            <div class="col-md-5">
                                ...
                                <?php 
						        if ($sdavatar == NULL) {
						        print' <img class="img-responsive" src="../assets/images/'.$mygender.'.png" alt="'.$sdfname.'">';
						        }else{
