                    ...
                    <div class="col-md-12">
                        <div class="col-md-5">
                            ...
                            <div class="col-md-7 text-right ">
                                 <a href="repo.php" target="_blank"><button class="btn btn-success">Skill Library</button></a>
                            </div>
                                ...
                                <div class="panel " >
                                    <div class="panel-body" >
                                        <div role="tabpanel" >
                                            ...
                                            <!--<button id="myBtn" class="btn btn-info">Invite Candidates</button>-->
                       ...
                       $sql = "SELECT * FROM tbl_categories ORDER BY status ASC";
                         ...
                         $st = '<p class="text-danger">INACTIVE</p>'; 
                                               ...
                                               <div class=" card col-md-3" style="height:120px;padding:20px 20px 20px 20px">
                                               <p style="font-weight:800;font-size:16px;color:#F58733;padding-top:5px;padding-bottom:5px;">'.$row['name'].'</p>
                                               

                                               <a class="btn " style="border:0px;color:black;text-decoration:none;border-radius:5px;font-size:14px;font-weight:500" href="testview.php?eid='.$row['name'].'" style="text-decoration:none;color:black" target="_blank">
                                               <i class="fa fa-eye "></i> View Test
                                               </a>
                                               &nbsp;&nbsp;
                                               <a class="btn " style="border:0px;color:#244C9F;text-decoration:none;border-radius:5px;font-size:14px;font-weight:500"  href="summary.php?eid='.$row['name'].'" target="_blank"><i class="fa fa-bar-chart "></i> Reports</a>
                    ...
                    <div class="form-group">
                      ...
                      $sql = "SELECT * FROM tbl_categories WHERE status = 'Active' ORDER BY name";
                       ...
                       ?>
                                        ...
                                        <div class="form-group" >
                                            <input type="text" class="form-control" placeholder="<?php echo $myfname.$mylname; ?>" name="recname"  autocomplete="off" value="<?php echo $myfname.$mylname; ?>" readonly>
                                        </div>
                                        <div class="form-group" style="display:none">
