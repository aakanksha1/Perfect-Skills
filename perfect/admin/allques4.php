                    ...
                    <div class="col-md-12">
                        <div class="col-md-5">
                            ...
                            <div class="col-md-7 text-right ">
                                <h3><a class="btn btn-info" href="repo.php">Back</a></h3>
                            </div>
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                        ...
                                        <div class="tab-content">
											...
											<?php 
											include '../database/config4.php';
											$sql = "SELECT * FROM tbl_questions WHERE exam_id = '$exam_id' LIMIT 15";
                                            $result = $conn->query($sql);
											...
											?>
<center><p class="text-info">Thank You for going througt the document, however only 15 Questions are dislpayed In Pilot Stage</p></center>
                                            </div>
