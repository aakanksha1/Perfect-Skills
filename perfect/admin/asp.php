                        ...
                        <div class="container-full" style="border-top:2px solid #0379BE;" >
                                ...
                                <div class="panel " >
                                    <div class="panel-body" >
                                        ...
                                        <div class="col-md-12">
                                            <h2 class="text-center" style="font-weight:800">ASP.NET MVC</h2>
                                               
                                               <?php
										   include '../database/config4.php';
										   $sql = "SELECT * FROM tbl_examinations WHERE exam_id='EX-332158' OR exam_id='EX-603936' OR exam_id='EX-651206' OR exam_id='EX-103911'";
