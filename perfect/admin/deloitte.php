                                        ...
                                        <div role="tabpanel" >
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div role="tabpanel" class="tab-pane active fade in" id="tab5" >
                                                    ...
                                                    <div class="col-md-12">
                                                        <h2>Questions asked by Deloitte Panel</h2>
										   <?php
										   include '../database/config.php';
										   $sql = "SELECT * FROM tbl_examinations WHERE exam_id='EX-777144' OR exam_id='EX-146607' OR exam_id='EX-423263' OR exam_id='EX-389928' OR exam_id='EX-157022' OR exam_id='EX-922419' ";
...
//                                        style=""
                                    ...
                                    ';
										   ...
										   $sql = "SELECT * FROM tbl_examinations WHERE category='Deloitte Recommended'";
                                           $result = $conn->query($sql);
...
//                                        style=""
                                    ...
                                    ';
										   ...
										   $sql = "SELECT * FROM tbl_examinations WHERE exam_id='EX-214248' OR exam_id='EX-692667' OR exam_id='EX-570332' OR exam_id='EX-791593' OR exam_id='EX-940526' OR exam_id='EX-507062' OR exam_id='EX-603936' ORDER BY exam_name";
                                           $result = $conn->query($sql);
...
//                                        style=""
                                    ...
                                    ';
                                        ...
                                        <div class="col-md-12">
                                            <h2 class="text-center" style="font-weight:800">C# and Data Structures</h2>
                                                <div class="card col-md-3" style="height:150px;padding:20px 20px 20px 20px">
                                               <p style="font-weight:800;font-size:16px;color:#F58733;padding-top:5px;padding-bottom:5px;">C#+Data Structures</p>
                                               
                                               
                                               <a href="http://test.sourcegamma.info/admin/allques.php?eid=EX-925204"target="_blank" class="btn btn-default">View Questions</a>
                                                </div>       
                                               <?php
										   include '../database/config4.php';
										   $sql = "SELECT * FROM tbl_examinations WHERE exam_id='EX-637640' OR exam_id='EX-734937' ORDER BY category";
                                           $result = $conn->query($sql);
                                    ...
                                    ';
										   ...
										   <?php
										   include '../database/config5.php';
										   $sql = "SELECT * FROM tbl_examinations WHERE exam_id='EX-154446'";
                                           $result = $conn->query($sql);
