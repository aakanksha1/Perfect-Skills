...
<head>
    ...
    <body <?php if ($ms == "1") { print 'onload="myFunction()"'; } ?>  class="page-header-fixed">
        ...
        <main class="page-content content-wrap">
            ...
            <div class="horizontal-bar sidebar" style="margin-top:50px">
                        ...
                        <li><a href="examinations.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-book"></span><p>Tests</p></a></li>
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
										...
										<div class="form-group">
                                            ...
                                            <input type="email" class="form-control" placeholder="Enter email address" name="email"  autocomplete="off">
                                        </div>
										<div class="form-group">
